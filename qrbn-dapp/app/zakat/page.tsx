											...
											<div className="p-4 bg-red-500/20 rounded-lg border border-red-500/30">
												<div className="text-center">
													...
													<p className="text-red-100 text-xs">
														Your wealth ({parseFloat(wealth).toLocaleString()} USDT) is below the nisab threshold (
														{nisabThreshold.toLocaleString()} USDT). Zakat is not obligatory for wealth below this amount.
													</p>
												</div>
											</div>
										)}

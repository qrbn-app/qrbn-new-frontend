	...
	return (
		<div className="flex items-center space-x-4">
			<div className="flex items-center space-x-2">
				<Badge className="bg-[#14532d] text-[#d1b86a]">{chain?.name || "Lisk Sepolia"}</Badge>
				<div className="text-sm text-[#f0fdf4]">{formatAddress(address!)}</div>
				<Button size="sm" variant="ghost" onClick={copyAddress} className="h-6 w-6 p-0 text-[#f0fdf4] hover:text-[#d1b86a]">
			...
			<div className="flex items-center space-x-3 text-sm">
				<div className="text-[#f0fdf4]/70">
					USDT: <span className="text-[#d1b86a]">{displayBalance} USDT</span>
				</div>
			</div>
